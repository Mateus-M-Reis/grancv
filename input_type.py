...
import cv2
import imutils
from app.neural_style_transfer import get_model_from_path, style_transfer
from data import *
...
def image_input(style_model_name):
	...
	#else:
	WIDTH = st.sidebar.select_slider('QUALITY', list(range(250, 1001, 50)), value=400)
	...
	st.sidebar.image(content, width=220, channels='BGR')
